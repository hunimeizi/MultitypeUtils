package com.multitype.utils.multitype;/*
...
public class MultiTypeAdapter extends RecyclerView.Adapter<ViewHolder>
    implements FlatTypeAdapter, com.multitype.utils.multitype.TypePool {

    @Nullable
    protected List<?> items;
    @NonNull
    protected com.multitype.utils.multitype.TypePool delegate;
    @Nullable
    ...
    @Override
    public void register(@NonNull Class<?> clazz, @NonNull
    ...
    public void applyGlobalMultiTypePool() {
        for (int i = 0; i < GlobalMultiTypePool.getContents().size(); i++) {
            ...
            final ItemViewProvider
                provider = GlobalMultiTypePool.getProviders().get(i);
